package com.momong.backend.unit.domain.member_game_record.service;
...
import com.momong.backend.domain.member_game_record.entity.GuardianPerkTypes;
import com.momong.backend.domain.member_game_record.entity.MonsterGameRecord;
import com.momong.backend.domain.member_game_record.entity.MonsterPerkTypes;
import com.momong.backend.domain.member_game_record.repository.MemberGameRecordRepository;
...
class MemberGameRecordCommandServiceTest {
    ...
    private GuardianGameRecord createGuardianGameRecord(
        ...
        return new GuardianGameRecord(
                ...
                gameRecord,
                GuardianType.SHIELDER,
                GuardianPerkTypes.create(List.of(DEFENSE_DODGE, DEFENSE_SHIELD, ATTACK_CHARGE_ATTACK)),
                100,
                150,
                0,
                2,
